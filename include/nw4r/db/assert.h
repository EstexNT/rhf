...
#define NW4R_DB_ASSERT(exp, line, ...)                                  \
    do {                                                                \
        if (!(exp)) { nw4r::db::Panic(__FILE__, line, __VA_ARGS__) }    \
    } while (0)
...
#define NW4R_ASSERT(x, line) NW4R_ASSERT_MSG((x), line, "NW4R:Failed assertion " #x)

#define NW4R_ASSERT_PTR_NULL(ptr, line) NW4R_ASSERT_MSG(            \
    (ptr) != 0, line, "NW4R:Pointer must not be NULL (" #ptr ")"    \
)

#define NW4R_ASSERT_PTR(x, line) NW4R_ASSERT_MSG(                                           \
    (((u32)(x) & 0xff000000) == 0x80000000) || (((u32)(x) & 0xff800000) == 0x81000000) ||   \
    (((u32)(x) & 0xf8000000) == 0x90000000) || (((u32)(x) & 0xff000000) == 0xc0000000) ||   \
    (((u32)(x) & 0xff800000) == 0xc1000000) || (((u32)(x) & 0xf8000000) == 0xd0000000) ||   \
